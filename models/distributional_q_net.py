...
class DistributionalQNet(TFModelV2):
    ...
    def __init__(
        ...
        super(DistributionalQNet, self).__init__(
            obs_space, action_space, num_outputs, model_config, name)
        print("using distributional_q_tf_model.py\n"*10)
...
ModelCatalog.register_custom_model("distributional_q_net", DistributionalQNet)