...
class MergeChangesNet(TFModelV2):
    """
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        value = tf.keras.layers.Dense(units=1, name="vf",
                                      kernel_initializer=tf.keras.initializers.Orthogonal(gain=1.0))(x)
...
ModelCatalog.register_custom_model("merge_changes_net", MergeChangesNet)
