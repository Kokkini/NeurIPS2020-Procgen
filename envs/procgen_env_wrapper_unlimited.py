...
class ProcgenEnvWrapperFewEnv(gym.Env):
    ...
    def __init__(self, config):
        self._default_config = {
            "num_levels" : 200,  # The number of unique levels that can be generated. Set to 0 to use unlimited levels.
            ...
            "use_generated_assets" : True,  # Use randomly generated assets in place of human designed assets
