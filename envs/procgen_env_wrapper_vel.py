...
class ProcgenEnvWrapperVel(gym.Env):
    """
    ...
    def __init__(self, config):
        self._default_config = {
            ...
            "paint_vel_info" : True,  # Paint player velocity info in the top left corner. Only supported by certain games.
...
registry.register_env(
    "procgen_env_wrapper_vel",
    lambda config: ProcgenEnvWrapperVel(config)
)
